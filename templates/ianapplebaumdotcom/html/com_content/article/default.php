...
?>
<article class="single-post post entry item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
	...
	<p><div class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image"> <img
